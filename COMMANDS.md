...
##### KIBANA AND MS INTEGRATION

python ml_test_analysis.py \
    --csv-file test-logs/test-datasets/modsec_test.csv \
    ...
    --elk-log-file /home/dan/Projects/RhynoWEBGUARD/juicy-shop/logs/ml_analysis_elk.log \
    --send-alert

fetch_emails --mark-read